package com.krunal.coroutinesvsrx

import android.os.Bundle
import androidx.annotation.UiThread
import androidx.appcompat.app.AppCompatActivity
import com.krunal.coroutinesvsrx.data.RetrofitClient
...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchDataCoroutines() {
        val restfulAPI = RetrofitClient.coroutineRestfulAPI
        launch(UI) {
            try {
    ...
    private fun fetchDataRx() {
        val restfulAPI = RetrofitClient.rxRestfulAPI
